                                ...
                                <ul class="mt-4" style="height: 275px;">
                                    <li style="font-size: 15px;">
                                        ...
                                        @else
                                            ...
                                            Terimakasih!, anda sudah mengupload semua dokumen. Cek di menu dokumen untuk
                                            melihat
                                    ...
                                    <li class="mt-2" style="font-size: 15px;">
                                        @if (@$isiProfil != null)
                                            ...
                                            Klik <a href="{{ url('profil') }}">menu profil</a> untuk mengisi dan melengkapi
                                            data profil.
                                        @else
                                            <i class="text-success bi bi-check-circle"></i>
                                            Terimakasih!, anda sudah mengisi semua data di menu profil. Cek di menu profil
                                            untuk
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($item->status == 'Perlu Diperbaiki')
                                                            <a href="#" style="border-radius: 8px !important;"
                                                                ...
                                                                <i style="font-size: 1.5rem;"
                                                                    class="text-success bi bi-grid"></i>
                                                            </a>
                                                        @endif
                                                    </td>
                                                </tr>
                    ...
                    @if (Auth::user()->role == 'Pegawai')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Dokumen" id="jenis_dokumen"
...
@push('script')
    ...
    <script>
        ...
        $('#modalExample').on('show.bs.modal', function(event) {
            ...
            const alasan_ditolak = button.getAttribute('data-bs-alasan_ditolak');
            ...
            modal.find('#alasan_ditolak').val(alasan_ditolak)
        })
