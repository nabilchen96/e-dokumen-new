    ...
    $("#myTable").DataTable({
        ...
        },
        {
            render: function (data, type, row, meta) {
                ...
                <b>Status</b>: ${row.status_pegawai == `Honorer` ? `Non ASN` : row.status_pegawai}
                `;
            }
        },
        {
        ...
        },
        {
            render: function (data, type, row, meta) {
                ...
                <b>TTL</b>: ${row.tempat_lahir}, ${row.tanggal_lahir} <br> 
                <b>Whatsapp</b>: ${row.no_wa}`
            }
        },
        {
            render: function (data, type, row, meta) {
                return `<a href="/detail-siasn-profil?nip=${row.nip}">
