                    ...
                    <div class="table-responsive">
                        <table width="100%">
                                ...
                                <td colspan="2">
                                    <div class="alert alert-info">
                                        <h5 style="line-height: 1.2em;">Beberapa data sudah terisi berdasarkan data kenaikan
                                            ...
                                            dan pastikan data sudah sesuai sebelum disubmit. Hanya admin dan user yang
                                            memiliki otoritas yang dapat mengedit
                                        </h5>
                                    </div>
                                    <br>
                                </td>
                            ...
                            <tr>
                                <td width="5%"></td>
                                <td width="10%">
                                    <img src="{{ asset('ilanding/logo.png') }}" style="width: 100%; height: 135px;"
                                        alt="">
                                </td>
                        ...
                        <form id="form">
                            <input {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }} required
                                type="hidden" name="id" id="id" value="{{ Request('data') }}">
                            <input {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }} required
                                type="hidden" name="id_profil" id="id_profil" value="{{ @$pegawai->id }}">
                            <table width="100%">
                                <tr>
                                    <td width="5%">
                                    ...
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="date" id="tgl_dokumen" name="tgl_dokumen"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" placeholder="Nomor" id="no_dokumen" name="no_dokumen"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" id="lampiran" name="lampiran"
                                            value="{{ @$kenaikan_gaji->lampiran ?? '-' }}"
                                            class="form-control border-danger">
                                    </td>
                                    <td></td>
                                    <td></td>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" class="form-control border-danger"
                                            value="{{ @$pegawai->name }}">
                                    </td>
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="date" class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" name="pangkat" id="pangkat"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" name="skpd" id="skpd"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="number" name="gaji_pokok_lama" id="gaji_pokok_lama"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" name="oleh_pejabat" id="oleh_pejabat"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="date" name="tgl_dokumen_sebelumnya"
                                            id="tgl_dokumen_sebelumnya"
                                    ...
                                    <td>
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" name="no_dokumen_sebelumnya"
                                            id="no_dokumen_sebelumnya" class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="date" name="tgl_berlaku_gaji" id="tgl_berlaku_gaji"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input
                                                {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                                required type="number" class="form-control border-danger"
                                                placeholder="Tahun" maxlength="2"
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input
                                                {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                                required type="number" class="form-control border-danger"
                                                placeholder="Bulan" id="masa_kerja_bulan_sebelumnya"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="number" name="gaji_pokok_baru" id="gaji_pokok_baru"
                                            class="form-control border-danger"
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input
                                                {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                                required type="number" class="form-control border-danger"
                                                placeholder="Tahun" value="{{ @$kenaikan_gaji->masa_kerja_tahun_baru }}"
                                                id="masa_kerja_tahun_baru" name="masa_kerja_tahun_baru" maxlength="2">
                                            <span style="height: 38px;" class="input-group-text border-danger"
                                                id="basic-addon2">Tahun</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <input
                                                {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                                required type="number" class="form-control border-danger"
                                                placeholder="Bulan" value="{{ @$kenaikan_gaji->masa_kerja_bulan_baru }}"
                                                id="masa_kerja_bulan_baru" name="masa_kerja_bulan_baru" maxlength="2">
                                            <span style="height: 38px;" class="input-group-text border-danger"
                                                id="basic-addon2">Bulan</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input name="golongan"
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="text" placeholder="Dalam Golongan"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="date" name="tgl_terhitung_mulai" id="tgl_terhitung_mulai"
                                            class="form-control border-danger"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <input
                                            {{ in_array(Auth::user()->role, ['Admin', 'OPD', 'SKPD']) ? '' : 'readonly' }}
                                            required type="date" name="tgl_kenaikan_berikutnya" readonly
                                            id="tgl_kenaikan_berikutnya"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <select {{ Auth::user()->role != 'Admin' ? 'disabled' : '' }} required
                                                ...
                                                @foreach ($instansi2 as $k)
                                                    <option
                                                        {{ @$kenaikan_gaji->id_profil_kepala == $k->id ? 'selected' : '' }}
                                                        value="{{ $k->id }}">{{ $k->name }} -
                                                        {{ $k->pangkat }} - NIP:
                                                        {{ $k->nip }}
                                                    </option>
